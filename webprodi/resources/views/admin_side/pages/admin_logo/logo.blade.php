        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                <h4 class="card-header font-weight-bold text-white text-center"
                    style="background: linear-gradient(-90deg, #0d5959 0%, #016666 100%);">Kelola Logo
                </h4>
                <div class="card-body">
                            ...
                            <div class="container mt-4">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 d-flex align-items-center justify-content-center">
                                        <img style="max-width:100%; height:auto; max-height: 150px; width: 100%;object-fit: cover;object-position: center;" src="{{ asset('assets/images/logo/' . env('PRODI_ID') . '.' . (file_exists(public_path('assets/images/logo/' . env('PRODI_ID') . '.jpg')) ? 'jpg' : (file_exists(public_path('assets/images/logo/' . env('PRODI_ID') . '.jpeg')) ? 'jpeg' : 'png'))) }}?v={{ time() }}" alt="Logo">
                                    </div>
