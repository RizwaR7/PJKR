            ...
            <div class="col-lg-12">
                <div class="card mb-4">
                    <h4 class="card-header font-weight-bold text-white text-center"
                        style="background: linear-gradient(-90deg, #0d5959 0%, #016666 100%);">Kelola SubMenu
                    </h4>
                    <a href="{{ route('admin_menu.index') }}" class="btn btn-sm btn-secondary"><i
                            class="fas fa-arrow-left"></i> Kembali
                        ke Menu Utama</a>
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">

                        <button type="button" id="btnModalMenuUtama" class="btn btn-md btn-info"><i
                                class="fas fa-plus"></i>
                            Tambah Data</button>
                    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var tableMenu = $("#dataTable").DataTable({
                ...
                serverSide: true,
                order: [],
                ajax: "{{ route('sub_menu.index', Request::segment(4)) }}",
                columns: [{
                        data: "nama",
                        name: "nama",
                    },
            ...
            $("#btnModalMenuUtama").click(function() {
                $("#saveBtn").val("create-sub-menu");
                $("#saveBtn").html("Tambah Sub-Menu");
                $("#modalTitle").html("Tambah Sub-Menu");
            ...
            $("body").on("click", ".editMenu", function() {
                ...
                $.get(
                    ...
                    function(data) {
                        $("#modalTitle").html("Edit Sub-Menu");
                        $("#saveBtn").val("edit-menu");
                        $("#saveBtn").html("Edit Sub-menu");
                        $("#modalMenuUtama").modal("show");
            ...
            $("#saveBtn").click(function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('sub_menu.index', Request::segment(4)) }}",
                    type: "POST",
                    dataType: "json",
