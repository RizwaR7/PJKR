...
class DetailPengumumanController extends Controller
{
    ...
    public function index($id)
    {
        ...
        $get_detail_berita = DB::table('pengumuman')
        ...
        if (empty($get_detail_berita)) {
            ...
            Pengumuman::where('id', $get_detail_berita->id)
                ->update(['counters' => $get_detail_berita->counters + 1]);
        }


        return view('client_side.pages.detail_pengumuman', compact('get_detail_berita', 'profil', 'menus', 'agenda', 'all', 'berita_popular', 'berita_recent'));
    }
