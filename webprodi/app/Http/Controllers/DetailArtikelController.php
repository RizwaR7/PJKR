...
class DetailArtikelController extends Controller
{
    ...
    public function index($id)
    {
        ...
        $get_detail_berita = DB::table('artikel')
        ...
        if (empty($get_detail_berita)) {
            ...
            Artikel::where('id', $get_detail_berita->id)
                ->update(['counters' => $get_detail_berita->counters + 1]);
        }


        return view('client_side.pages.detail_artikel', compact('get_detail_berita', 'profil', 'menus', 'agenda', 'all', 'berita_popular', 'berita_recent'));
    }
