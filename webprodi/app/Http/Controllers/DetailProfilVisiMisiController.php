...
class DetailProfilVisiMisiController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $profil_visimisi = Profil::where('id_sms', (int)env('PRODI_ID'))->orderBy('id', 'asc')->first();
        ...
        return view('client_side.pages.profil_visimisi', compact('menus', 'profil_visimisi', 'agenda', 'berita_popular', 'berita_recent'));
    }
